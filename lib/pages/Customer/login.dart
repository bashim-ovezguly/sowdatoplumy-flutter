...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Içeri gir", style: CustomText.appBarText,),),
      body: Center(
              ...
              child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    prefixIcon: Container(
                      ...
                      width: 40,
                      child: Text('+993', style: TextStyle(fontSize: 17),),
                    ),
            ...
            Container(
                ...
                Container(
                  ...
                  margin: EdgeInsets.only(left: 60, top: 5),
                        child: GestureDetector(
                          ...
                          child: Text('Agza bolduňyzmy ?', style: TextStyle(fontSize: 16, decoration: TextDecoration.underline,),),
                        )
                      ),
              ...
              Container(
                ...
                child: GestureDetector(
                          ...
                          child: Text('Açar sözümi ýadymdan çykardym !', style: TextStyle(fontSize: 16, decoration: TextDecoration.underline,),),
                        )
                      ),
          ],
        )
