...
class AutoPartsAdd extends StatefulWidget {
  AutoPartsAdd({Key? key, required this.customer_id, required this.refreshFunc})
      : super(key: key);
  final String customer_id;
  final Function refreshFunc;
  @override
  State<AutoPartsAdd> createState() =>
      _AutoPartsAddState(customer_id: customer_id);
}
