...
class GetAutoParthFirst extends StatefulWidget {
  GetAutoParthFirst({Key? key, required this.customer_id, required this.id, required this.refreshFunc}) : super(key: key);
  final String id;
  final String customer_id;
  final Function refreshFunc;

  @override
  State<GetAutoParthFirst> createState() => _GetAutoParthFirstState(id: id, customer_id: customer_id);
}
        ...
        Align(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GetAutoParthFirst(id:id, customer_id: customer_id, refreshFunc: widget.refreshFunc,)));
            },
