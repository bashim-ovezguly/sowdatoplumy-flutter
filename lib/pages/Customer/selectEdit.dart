...
class MyDropdownButtonEdit extends StatefulWidget {
  ...
  MyDropdownButtonEdit({required this.items, required this.callbackFunc, required this.text});
  @override
  _MyDropdownButtonEditState createState() => _MyDropdownButtonEditState(callbackFunc: callbackFunc, text: text);
}
      ...
      DropdownButton<String>(
        ...
        items: widget.items.map((value) {
          return DropdownMenuItem<String>(
              ...
              child:  FittedBox(
                fit: BoxFit.contain,
                child: value['name'] != null? Text(value['name'].toString(),style: const TextStyle(fontSize: 17, color: CustomColors.appColors),):
