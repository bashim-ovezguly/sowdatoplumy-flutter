...
class GetConstructionFirst extends StatefulWidget {
  GetConstructionFirst({Key? key, required this.id, required this.refreshFunc}) : super(key: key);
  final String id;
  final Function refreshFunc;
  @override
  State<GetConstructionFirst> createState() => _GetConstructionFirstState(id: id);
}
        ...
        Align(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GetConstructionFirst(id:id, refreshFunc: widget.refreshFunc,)));
            },
