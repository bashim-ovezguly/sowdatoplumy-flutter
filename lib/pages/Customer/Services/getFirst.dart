...
class ServiceDetail extends StatefulWidget {
  ServiceDetail({Key? key, required this.id, required this.refreshFunc}) : super(key: key);
  final String id ;
        ...
        Align(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ServiceDetail(id:id, refreshFunc: widget.refreshFunc,)));
            },
