...
class MyRibbonDetail extends StatefulWidget {
  ...
  MyRibbonDetail({Key? key, required this.id, required this.refreshListFunc}) : super(key: key);
  @override
            ...
            List<PopupMenuEntry<String>> menuEntries2 = [
              PopupMenuItem<String>(
                  child: GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MyRibbonEdit(id: widget.id, refreshListFunc: widget.refreshListFunc)));  
              ...
              PopupMenuItem<String>(
                  child: GestureDetector(
                      onTap: () {
                          ...
                          context: context,
                          builder: (context){
                            return DeleteAlert(action: 'lenta', id: widget.id, callbackFunc: callbackStatusDelete,);});
                      },
                      child: Container(
                          color: Colors.white,
                          height: 40,
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: Container(
                      ...
                      child: Image.network( baseurl + i['img'], fit: BoxFit.cover,),
                    )
                  )
                )
            ]
