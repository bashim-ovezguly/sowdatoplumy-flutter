...
class GetRealEstateFirst extends StatefulWidget {
  GetRealEstateFirst({Key? key, required this.id, required this.refreshFunc}) : super(key: key);
...
class _GetRealEstateFirstState extends State<GetRealEstateFirst> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Menin sagypam", style: CustomText.appBarText,),
      ...
      body: status==false? determinate? ListView(
        children: <Widget>[
          Container(
              ...
              child:  Row(
                children: <Widget>[
                  Text("Emläkler", style: TextStyle(color: CustomColors.appColors, fontSize: 18,),),
                ],
              )
          ),
          Stack(
        ...
        Align(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GetRealEstateFirst(id:id, refreshFunc: widget.refreshFunc,)));
            },
