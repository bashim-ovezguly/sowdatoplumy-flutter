...
class GetCarFirst extends StatefulWidget {
  GetCarFirst({Key? key, required this.id, required this.refreshFunc}) : super(key: key);
  final String id;
      ...
      determinate? ListView(
        children: <Widget>[
          Container(
              ...
              child:  Row(
                children: <Widget>[
                  Text(name_title, style: TextStyle(color: CustomColors.appColors, fontSize: 18,),),
                  ],)),
                    Stack(
                    ...
                    items: imgList
                      ...
                      child: Center(
                          child: ClipRRect(
                            ...
                            child: Image.network(item, fit: BoxFit.cover, height: 200,width: double.infinity,),)
                      ),)).toList(),),
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: SizedBox(child:
                  data['recolored'] != null && data['recolored']==true? TextValueWidget(text: "howwa", size: 17.0): TextValueWidget(text: "ýok", size: 16.0),))
              ],),),
          Container(
            height: 30,
            margin: const EdgeInsets.only(left: 10),
        ...
        Align(
          child: ElevatedButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => GetCarFirst(id:id, refreshFunc: widget.refreshFunc,)));
            },
...
class EditAlert extends StatefulWidget {
  EditAlert({Key? key, required this.title, required this.value}) : super(key: key);
  final String title;
  final String value;

  @override
  State<EditAlert> createState() => _EditAlertState(title: this.title, value: this.value);
}
          ...
          children: [
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(border: OutlineInputBorder(borderSide: BorderSide.none,),
                  filled: true, hintText: value,  fillColor: Colors.white,
              ...
              child: Row(
                children: <Widget>[
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: CustomColors.appColors, width: 2),
                      ),
                      child: Container(
                          width: 20,
                          height: 20,
                  ...
                  GestureDetector(
                    ...
                    child: Text("Tassyklayaryn", style: TextStyle(fontSize: 20),),
                  )
                ],
              ),
            ),
