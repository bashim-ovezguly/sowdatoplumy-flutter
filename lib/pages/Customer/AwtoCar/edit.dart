...
class EditCar extends StatefulWidget {
  ...
  EditCar({Key? key, required this.old_data, required this.callbackFunc})
      : super(key: key);
  var old_data;
  @override
  State<EditCar> createState() =>
      _EditCarState(old_data: old_data, callbackFunc: callbackFunc);
}
    ...
    return Scaffold(
        ...
        body: ListView(scrollDirection: Axis.vertical, children: <Widget>[
          Container(
              ...
              child: const Text("Awtoulag üýtgetmek",
                  style: TextStyle(
                      fontSize: 17,
          ...
          InputSelectText(
              ...
              items: marks,
              oldData: old_data['mark']),
          InputSelectText(
              title: "Model",
              height: 40.0,
              callFunc: callbackModel,
              items: models,
              oldData: old_data['model']),
          ...
          InputText(
              ...
              height: 40.0,
              callFunc: setYear,
              oldData: old_data['year'].toString()),
          InputText(
              title: "Bahasy",
              height: 40.0,
              callFunc: setPrice,
          ...
          InputText(
              ...
              height: 40.0,
              callFunc: setMillage,
              oldData: old_data['millage'].toString()),
          InputSelectText(
              title: "Reňki",
              height: 40.0,
              callFunc: callbackColor,
              items: colors,
              oldData: old_data['color']),
          InputText(
              title: "Matory",
              height: 40.0,
              callFunc: setEngine,
              oldData: old_data['engine'].toString()),
          InputSelectText(
              title: "Kuzow görnüşi",
              height: 40.0,
              callFunc: callbackBodyType,
              items: body_types,
              oldData: old_data['body_type']),
          InputSelectText(
              title: "Karopka görnüşi",
              height: 40.0,
              callFunc: callbackTransmission,
              items: transmissions,
              oldData: old_data['transmission']),
          InputSelectText(
          ...
          InputText(
              ...
              height: 40.0,
              callFunc: setVin,
              oldData: old_data['vin']),
          InputText(
              title: "Giňişleýin maglumat",
              height: 100.0,
              callFunc: setDescription,
              oldData: old_data['description']),
          SizedBox(height: 10),
          Container(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Container(
        width: 200,
        height: 100,
        child: Text('Maglumat üýtgedildi operatoryň tassyklamagyna garaşyň'),
      ),
      actions: <Widget>[
        Align(
          child: ElevatedButton(
