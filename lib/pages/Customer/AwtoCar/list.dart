...
import 'package:my_app/pages/Customer/AwtoCar/addCar.dart';
import 'package:my_app/pages/Customer/AwtoCar/getFirst.dart';
...
class _MyCarsState extends State<MyCars> {
        ...
        children: <Widget>[
          Expanded(flex: 1, 
            child: Row(
              children: [
                if (data.length>0)
                  Align(alignment: Alignment.centerLeft,child: Container( padding: const EdgeInsets.only(left: 10, top: 5),child:  Text("Awtoulaglar sany" + data.length.toString() ,style: TextStyle(fontSize: 18, color:CustomColors.appColors),),),),
                if (data.length==0)
                  Align(alignment: Alignment.centerLeft,child: Container( padding: const EdgeInsets.only(left: 10, top: 5),child:  Text("Sizde şu wagtlykca Awtoulag yok " ,style: TextStyle(fontSize: 16, color:CustomColors.appColors),),),),
              ],)),
          Expanded(flex: 12,child:ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: (){ 
                   Navigator.push(context, MaterialPageRoute(builder: (context) => GetCarFirst(id: data[index]['id'].toString(), refreshFunc: refreshFunc)));  
                  },
                child: Container(
  ...
  void get_my_cars({required customer_id}) async {
    ...
    String url = server_url.get_server_url() + '/mob/cars?customer=$customer_id';
