...
class _EditProfilState extends State<EditProfil> {
  ...
  removePhone(item) async {
    ...
    Uri uri = Uri.parse(
        serverIp + '/mob/stores/phone/delete/' + item['id'].toString());
  ...
  removeLink(item) async {
    ...
    Uri uri = Uri.parse(
        serverIp + '/mob/stores/link/delete/' + item['id'].toString());
    var response = await http.post(uri, headers: global_headers);
    this.setState(() {});
  }
  ...
  deleteImage() async {
    ...
    var response = await http.put(
        Uri.parse(serverIp + '/mob/stores/' + customer_id.toString()),
        body: body,
        headers: headers);
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    prefixIconColor: CustomColors.appColor,
