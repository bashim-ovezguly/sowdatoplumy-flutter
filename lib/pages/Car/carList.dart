...
import 'package:my_app/pages/sortWidget.dart';
...
class _CarState extends State<Car> {
                    ...
                    ? CustomScrollView(slivers: [
                        ...
                        SliverList(
                          ...
                          String created_at = data[index]['created_at']
                              .toString()
                              .split(' ')[0];
                          String imgUrl = serverIp + data[index]['img'];
  ...
  show_sort_dialog(BuildContext context) {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) {
        return SortDialog(sort_value: sort, callbackFunc: callbackFilter);
      },
    );
  }

  void get_carlist() async {
    String url = carsUrl + '?sort=' + sort.toString();
