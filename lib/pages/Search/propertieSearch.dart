...
class PropertieSearch extends StatefulWidget {
  ...
  @override
  State<PropertieSearch> createState() =>
      _PropertieSearchState(callbackFunc: callbackFunc);
}
          ...
          Expanded(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: CustomCheckBox(
                    labelText: 'Eýesinden',
                    callbackFunc: callbackAtCustomer,
                    status: false),
              ),
            ],
          )),
            ...
            child: InkWell(
              ...
              onTap: () {
                ...
                if (floorController.text != '') {
                  params['floor'] = floorController.text.toString();
                }
                if (nameController.text != '') {
                  params['name'] = nameController.text.toString();
                }
                if (at_floorController.text != '') {
                  params['at_floor'] = at_floorController.text.toString();
                }
                if (roomCountController.text != '') {
                  params['room_count'] = roomCountController.text.toString();
                }
                if (categoryController != {}) {
                  params['category'] = categoryController['id'].toString();
                }
                if (remontStateController != {}) {
                  params['remont_state'] =
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            ProperrieSearchList(params: params)));
              },
              child: Icon(
                Icons.search,
                color: Colors.white,
