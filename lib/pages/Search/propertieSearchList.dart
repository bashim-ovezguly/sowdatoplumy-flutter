...
class ProperrieSearchList extends StatefulWidget {
  ...
  @override
  State<ProperrieSearchList> createState() =>
      _ProperrieSearchListState(params: params);
}
...
class _ProperrieSearchListState extends State<ProperrieSearchList> {
  ...
  void getproductlist() async {
    ...
    if (params['floor'] != null) {
      url = url + 'floor=' + params['floor'] + "&";
    }
    if (params['at_floor'] != null) {
      url = url + 'at_floor=' + params['at_floor'] + "&";
    }
    if (params['room_count'] != null) {
      url = url + 'room_count=' + params['room_count'] + "&";
    }
    ...
    if (params['remont_state'] != 'null') {
      url = url + 'remont_state=' + params['remont_state'] + "&";
    }
