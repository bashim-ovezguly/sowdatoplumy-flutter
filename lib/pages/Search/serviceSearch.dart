...
class ServiceSearch extends StatefulWidget {
  ...
  ServiceSearch({Key? key, required this.callbackFunc}) : super(key: key);

  @override
  State<ServiceSearch> createState() => _ServiceSearchState(callbackFunc: callbackFunc);
}

class _ServiceSearchState extends State<ServiceSearch> {
  final Function callbackFunc;
  _ServiceSearchState({required this.callbackFunc});
            ...
            child: Ink(
              ...
              child: InkWell(
                ...
                onTap: () {
                  ...
                  if (nameCodeController.text != ''){ params['name'] = nameCodeController.text.toString();}
                 ...
                 Navigator.push(context, MaterialPageRoute(builder: (context) => ServiceSearchList(params: params) ));
                },
                child: Icon(
                  Icons.search,
                  color: Colors.white,
