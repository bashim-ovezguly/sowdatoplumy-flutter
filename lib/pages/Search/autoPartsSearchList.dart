...
class AutoPartsSearchList extends StatefulWidget {
  ...
  @override
  State<AutoPartsSearchList> createState() =>
      _AutoPartsSearchListState(params: params);
}
                    ...
                    ? Column(children: [
                        Container(
                            ...
                            child: Row(children: <Widget>[
                              Text("Awtoulaglaryn - " + total_price.toString(),
                                  style: TextStyle(
                                      fontSize: 20,
                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: <Widget>[
                                                                        Expanded(
                                                                            child:
                                                                                Container(alignment: Alignment.centerLeft, child: Text(data[index]['name_tm'].toString(), style: CustomText.itemTextBold))),
                                                                        Expanded(
                                                                            child:
                                                                                Container(alignment: Alignment.centerLeft, child: Text(data[index]['location'].toString(), style: CustomText.itemText))),
                                                                        Expanded(
                                                                            child:
                                                                                Container(alignment: Alignment.centerLeft, child: Text(data[index]['price'].toString(), style: CustomText.itemText))),
                                                                        if (data[index]['delta_time'] !=
                                                                                null &&
                                                                            data[index]['delta_time'] !=
                                                                                '')
                                                                          Expanded(
                                                                              child: Container(alignment: Alignment.centerLeft, child: Text(data[index]['delta_time'].toString())))
                                                                      ])))
                                                        ]))))));
                              }),
                        )
