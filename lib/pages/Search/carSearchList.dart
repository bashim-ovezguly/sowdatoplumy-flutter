...
class _CarSearchListState extends State<CarSearchList> {
  ...
  void getcarlist() async {
    ...
    if (params['body_type']!='null'){ url = url + 'body_type=' + params['body_type'] + "&"; }
    if (params['color']!='null'){ url = url + 'color=' + params['color'] + "&"; }
    ...
    if (params['vin']!=null){ url = url + 'vin=' + params['vin'] + "&"; }
    ...
    if (params['recolored']!=null && params['recolored']=='on'){ url = url + 'recolored=' + params['recolored'] + "&"; }
