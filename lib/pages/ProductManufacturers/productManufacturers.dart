...
class _ProductManufacturersState extends State<ProductManufacturers> {
  ...
  timers() async {
    ...
    setState(() {
      if (determinate == false && determinate1 == false) {
        status = false;
      }
    });
    print('done');
                          ...
                          SliverList(
                            ...
                            (BuildContext context, int index) {
                              return GestureDetector(
                                onTap: () {
                                  Navigator.pushNamed(
                                      context, '/productManufacturers/detail');
                                },
                                child: Stack(
  ...
  void getfactorieslist() async {
    ...
    String url =
        server_url.get_server_url() + '/mob/factories?' + sort_value.toString();
