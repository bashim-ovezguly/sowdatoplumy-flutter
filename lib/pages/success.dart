...
class SuccessAlert extends StatefulWidget {
  ...
  SuccessAlert({Key? key, required this.action, required this.callbackFunc})
      : super(key: key);
  @override
  _SuccessAlertState createState() =>
      _SuccessAlertState(action: action, callbackFunc: callbackFunc);
}
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Container(
        width: 200,
        height: 100,
        child: Text('Maglumat goşuldy operatoryñ tassyklamagyna garaşyñ'),
      ),
      actions: <Widget>[
        Align(
