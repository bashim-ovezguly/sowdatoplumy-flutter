...
class StoreFirst extends StatefulWidget {
  StoreFirst({Key? key, required this.id, required this.title})
      : super(key: key);
  final String id;
  final String title;
        ...
        ? Scaffold(
            ...
            appBar: AppBar(
                title: Column(
                    ...
                    children: [
                  data['name_tm'] != null && data['name_tm'] != ''
                        ...
                        children: <Widget>[
                          Container(
                              ...
                              child: Container(
                                  ...
                                  child: data['img_m'] != null &&
                                          data['img_m'] != ''
                                      ? Image.network(
                                          baseurl + data['img_m'].toString(),
                                          fit: BoxFit.cover)
                                      : Image.asset(
