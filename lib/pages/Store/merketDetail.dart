                        ...
                        child: Row(children: [
                          Expanded(child: Row(
                            children: [
                              ...
                              Expanded(child: Text(
                                data['location'].toString(), style: TextStyle(fontSize: 15, color: CustomColors.appColors),maxLines: 2,)),
                              SizedBox(width: 10,),
                            ],),),
                      Container(height: 10, child: Text(''),),
                      SizedBox(  
                        child: Row(children: [
                          Expanded(child: Row(
                            children: [
                              ...
                              Expanded(child: Text(
                                data['size'].toString(), style: TextStyle(fontSize: 15, color: CustomColors.appColors),maxLines: 2,)),
                              SizedBox(width: 10,),
                            ],),),
