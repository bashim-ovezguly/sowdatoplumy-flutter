...
class _MarketDetailState extends State<MarketDetail> {
  ...
  change_modul(value) async {
    setState(() {
      modul = value.toString();
                                                        ...
                                                        child: ElevatedButton(
                                                          ...
                                                          onPressed: () async {
                                                            ...
                                                            if (data.length ==
                                                              ...
                                                              var shoping_cart_item = await dbHelper.get_shoping_cart_item(
                                                                  soping_cart_id: array[
                                                                              0]
                                                                          ['id']
                                                                      .toString(),
                                                                  product_id: item[
  ...
  get_products_modul(modul, id) async {
    Urls server_url = new Urls();
    var param = '';
    if (modul == '0') {
      param = 'products';
