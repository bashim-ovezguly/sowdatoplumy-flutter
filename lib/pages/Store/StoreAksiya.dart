...
class StoreAksiya extends StatefulWidget {
  final storeId;
  const StoreAksiya({super.key, this.storeId});
  @override
  State<StoreAksiya> createState() => _StoreAksiyaState();
}

class _StoreAksiyaState extends State<StoreAksiya> {
  ...
  void getData() async {
    ...
    final storeId = widget.storeId.toString();
    url = url +
        "?store=$storeId&page=$_pageNumber&page_size=$_numberOfPostPerRequest";
    final uri = Uri.parse(url);
